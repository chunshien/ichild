...
class Common_IconMenu extends Component {
    ...
    _initStyle() {
        ...
        if (this.props.textDecorationLine && this.props.textDecorationLine != this.style.textDecorationLine) {
            this.style.textDecorationLine = this.props.textDecorationLine
        }
    ...
    render() {
        ...
        var _renderIconWithImageAndText = () => {
            ...
            const textStyle = {
                ...
                textDecorationLine: this.style.textDecorationLine
            }
            const imageStyle = {
                height: this.style.imageHeight,
                width: this.style.imageWidth,
            ...
            if (this.style.textPosition === 'top') {
                ...
                return (
                    <View style={[styles.rowLayout, this.props.rowLayout]}>
                        <Image
                            defaultSource={this.props.defaultSource}
                            source={this.style.imageSource}
                            resizeMode={this.style.imageResizeMode}
                ...
                return (
                    <View
                        style={[styles.rowLayout, this.props.rowLayout]}>
                        <Text
                            ellipsizeMode= {this.props.ellipsize==true ? 'tail' : null}
                            numberOfLines={this.props.ellipsize==true ? 1 : null}
                            style={{...textStyle,...this.style.gapAround}}>
